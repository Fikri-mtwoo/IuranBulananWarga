...
class transaksiModel extends CI_Model {
    ...
    var $kolom_order = array(null,'IdTransaksi','Nama','IdBulan','NamaPetugas','JmlBayar','TanggalBayar');
    var $kolom_cari = array('Nama','Tanggalbayar');
    var $order = array('IdTransaksi'=>'asc');

    private function get_datatables_query(){
        $this->db->select('IdTransaksi,Nama,NamaBulan,Tahun,NamaPetugas,JmlBayar,TanggalBayar');
