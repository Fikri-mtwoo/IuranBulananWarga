...
class kebijakanModel extends CI_Model {
    var $table = 'tablekebijakan';
    var $kolom_order = array(null, 'Nama');
    var $kolom_cari = array('Nama');
    var $order = array('IdKebijakan'=>'asc');

    private function get_datatables_query(){
        $this->db->from($this->table);
        $this->db->join('tablewarga', 'tablewarga.IdWarga = tablekebijakan.IdWarga');
        $i=0;
