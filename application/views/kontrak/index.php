    ...
    <div class="row">
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Rumah Kontrak</li>
                </ol>
            </nav>  
        </div>
    </div>
     ...
     <div class="notif" data-name="<?=$this->session->flashdata('name')?>" data-jenis="<?=$this->session->flashdata('type')?>" data-notif="<?=$this->session->userdata('flash')?>"></div>
        <div class="card">
            <div class="card-header">
                <a href="<?=base_url('Kontrak/tambah')?>" class="btn btn-success">Tambah data</a>
            </div>
            <div class="card-body">
                <div class="row">
                  <div class="col-md">
                  <table class="table table-striped table-bordered" id="tablekontrak">
                    <thead>
                      <tr>
                        <th scope="col">No</th>
